...
if (isset($_SESSION['id'])) {
    ...
    if (isset($_GET['id']) && !empty($_GET['id']) && is_numeric($_GET['id'])) {
        ...
        $s_details_sql = "SELECT *, SUM(QUANTITY) AS TOTAL_QUANTITY, SUM(AMOUNT) AS TOTAL_AMOUNT FROM sales_details WHERE TRANSACTION_ID = $transactionID GROUP BY PRODUCT_ID";
