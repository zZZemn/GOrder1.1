$(document).ready(function () {
  ...
  function loadXMLDoc() {
    ...
    const url =
      "../server/sales-return-update.php?id=" +
  ...
  $(document).on("click", "#submit_return", function (event) {
    ...
    if (
      ...
      inventory[0].reason != null &&
      inventory[0].transaction_id != null
    ) {
  ...
  $(document).on("input", 'input[name="rtn_quantity"]', function () {
    ...
    var alertElement = $(this)
      .closest(".qty-td")
      .find(".alert-when-reach-maxlevel");
    var alertInvalidQtyInput = $(this)
      .closest(".qty-td")
      .find(".alert-when-invalid-qty");
