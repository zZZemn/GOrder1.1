...
<head>
    ...
    <link rel="stylesheet" href="../css/reports-yearly-sales.css">
    ...
    <?php if (isset($emp) && $emp["EMP_TYPE"] == "Admin" && $emp['EMP_STATUS'] == "active") : ?>
        ...
        <div class="sidenav">
            ...
            <div class="dropdown-container">
                ...
                <a href="reports-yearly-sales.php" class="nav-active"><i class="fa-solid fa-chart-column"></i>Yearly Sales</a>
            ...
            <div class="table-container">
                <table class="table table-striped">
                    ...
                    <tbody id="table-response-container">
                        <?php
                        $year_sql = "SELECT YEAR(DATE) AS year, SUM(TOTAL) AS total_sales, SUM(VAT) AS total_vat FROM sales GROUP BY YEAR(DATE)";
