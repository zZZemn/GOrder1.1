    ...
    <?php if (isset($emp) && $emp["EMP_TYPE"] == "Admin" && $emp['EMP_STATUS'] == "active") : ?>
        ...
        <div class="sidenav">
            ...
            <div class="dropdown-container">
                ...
                <a href="logs-customer.php" class="nav-active"><i class="fa-solid fa-people-group"></i>Customer</a>
            </div>
                ...
                <table class="table table-striped">
                    <thead>
                        <tr>
                            <th colspan="11">
                                <center>
                                    <p class="year-text">Customer Logs</p>
                                </center>
                                <div class="filtering-container d-flex justify-content-end">
                                    <div class="input-container m-2">
                                        ...
                                        <select id="logType" class="form-control">
                                            ...
                                            <option value="upload">Upload Valid ID</option>
        ...
        <script src="../js/logs-customer.js"></script>
