...
<head>
    ...
    <title>GOrder | Notification</title>
</head>
...
<body>
    <?php if (isset($emp) && $emp["EMP_TYPE"] == "Admin" && $emp['EMP_STATUS'] == "active") : ?>
        ...
        <div class="sidenav">
            ...
            <a href="notification.php" class="mobile-only nav-active"><i class="fa-solid fa-bell"></i>Notification</a>
        ...
        <div class="main">
            ...
            <div class="container p-2 notif-page-notification-container">
                <?php
                ...
                ?>
                        ...
                        if ($inventory_result->num_rows > 0) {
                            ...
                            if ($product_qty == 0) {
                            ?>
                                <p class="text-dark"><span class="text-danger">* </span><?php echo $product_name . ' is out of stock.'; ?></p>
                            <?php

                            } elseif ($product_qty <= $critical_level) {
                            ?>
                                <p class="text-dark"><span class="text-warning">*</span><?php echo $product_name . ' is on critical level.'; ?></p>
                    <?php
                            }
                        }
                    }
