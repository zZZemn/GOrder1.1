...
<?php if (isset($emp) && $emp["EMP_TYPE"] == "Admin" && $emp['EMP_STATUS'] == "active" && isset($product['PRODUCT_NAME']) && isset($product['PRODUCT_ID'])): ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <body class="container p-5 d-flex justify-content-center align-items-center bg-primary">
        ...
        <div class="del-container mt-5 row d-flex text-center" method="post">
            ...
            <div class="button mt-5">
                <a href="products-allproducts.php" class="btn btn-primary m-2">Cancel</a>
                <a href="../process/delete-product-process.php?product_id=<?php echo $product['PRODUCT_ID'] ?>" class="btn btn-danger m-2">Delete</a>
            </div>
        </div>
