...
<body>
    <?php if (isset($emp) && $emp["EMP_TYPE"] == "Admin" && $emp['EMP_STATUS'] == "active") : ?>
        ...
        <div class="sidenav">
            ...
            <div class="dropdown-container">
                <a href="maintenance-tax.php" class="nav-active"><i class="fa-solid fa-percent"></i>Tax</a>
        ...
        <div class="main">
            ...
            <form class="tax-rate-container" method="post" action="../process/maintenance-tax-process.php">
