    ...
    <?php if (isset($emp) && $emp["EMP_TYPE"] == "Admin" && $emp['EMP_STATUS'] == "active") : ?>
        ...
        <div class="sidenav">
            ...
            <div class="dropdown-container">
                ...
                <a href="products-return.php" class="nav-active"><i class="fa-solid fa-rotate-left"></i>Returns</a>
        ...
        <script src="../js/products-return.js"></script>
