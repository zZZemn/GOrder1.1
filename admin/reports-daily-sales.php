...
<body>
    <?php if (isset($emp) && $emp["EMP_TYPE"] == "Admin" && $emp['EMP_STATUS'] == "active") : ?>
        ...
        <div class="sidenav">
            ...
            <div class="dropdown-container">
                <a href="reports-daily-sales.php" class="nav-active"><i class="fa-solid fa-chart-column"></i>Daily Sales</a>
